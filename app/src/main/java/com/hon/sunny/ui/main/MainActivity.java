...
//        mCompositeSubscription.unsubscribe();
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        new WeatherPresent(WeatherRepository.getInstance(WeatherRemoteDataSource.getInstance()), (WeatherContract.View) mWeatherFragment);
        new MultiCityPresenter(MultiCityRepository.getInstance(MultiCityRemoteDataSource.getInstance()), (MultiCityContract.View) mMultiCityFragment);
